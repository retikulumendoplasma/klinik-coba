  ...
  <table class="table table-striped">
      ...
      <tbody>
          @forelse ($dataRekamMedis as $rekamMedis)
              <tr data-url="/rekamMedisPasien/{{ $rekamMedis->patients->id_pasien }}" style="cursor: pointer;">
                  ...
                  <td>
                    <a href="/rekamMedisPasien/{{ $rekamMedis->patients->id_pasien }}" class="badge bg-info">
                    ...
                    <form action="/rekamMedis/{{ $rekamMedis->mr }}" method="post" class="d-inline" >
                      @csrf
                      @method('DELETE')
