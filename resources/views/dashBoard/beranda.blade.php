        ...
        <div class="col-md-4">
            <div class="text-center position-relative">
                <a href="/saranMasukanAdmin" class="text-reset text-decoration-none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="160" height="160" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16" style="color: green;">
